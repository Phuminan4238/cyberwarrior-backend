...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-FYGVSTZ6.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-ID6EFYT7.js").then((mod) => ({
          default: mod.App
        })),
...
//# sourceMappingURL=chunk-VH6OXPC5.js.map
